...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get('http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=' + zipcode + '&distance=25&API_KEY=C6EF47DE-20A5-4AC2-B021-F0840B2F9200')
        ...
        api_request = requests.get('http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=70503&distance=25&API_KEY=C6EF47DE-20A5-4AC2-B021-F0840B2F9200')
